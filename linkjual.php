...
<div class="topnav" style="border-radius: 15px">
  ...
  <a href="jualindex.php" target="_top">
  <i class="fa fa-list-ol"></i> Utama</a>
  
  <a href="jualstok.php" target="_top">
  <i class="fa fa-list-ol"></i> Stok</a>
  ...
  <div class="dropdown">   
    ...
    <div class="dropdown-content">
      <a href="jualitem.php"><i class="fa fa-plus"></i> Senarai Laptop</a>
      <a href="jualtambahitem.php"><i class="fa fa-plus"></i> Tambah Laptop</a>
    </div>
  </div>
