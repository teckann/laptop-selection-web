...
$senaraisql = mysqli_query($conntodb,"SELECT * FROM tbl_pengguna WHERE jenis='jual'");
...
<html>
	...
	<body>
		...
		<hr>
		<center><h3>Batu Pahat &nbsp; &nbsp; &nbsp; |  &nbsp; &nbsp; &nbsp; Senarai Kedai</h3></center>
		<hr>
		<br>
		...
		<center><table class="table" border="1" width="90%" id="pembesar">
			...
			<?php
				...
				$tambahan="where jenis='jual'";
				if(!empty($_POST['nama']))
				{
					$tambahan= "WHERE nama like '%".$_POST['nama']."%' AND jenis='jual'";
				}
