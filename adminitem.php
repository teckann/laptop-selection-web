...
header("Location: index.php"); 
	...
	$stoksql = mysqli_query($conntodb,"SELECT * FROM tbl_laptop INNER JOIN tbl_jenama ON tbl_jenama.idjenama = tbl_laptop.idjenama");
	...
	<center><table class="table" border="1" width="90%" id="pembesar">
		...
		<td width='60%'><img src="<?php echo $row['gambar']; ?>" width="200px"/></td>
			<td>
				...
				<b>Warna:</b>		<?php echo $row['warna']; ?><br><br>
				<div align="center"><a href ="adminpadamitem.php?recordID=<?php echo $row ['idlaptop'];?>"><button class="padam" type="button" style="border-radius: 18px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Padam &nbsp;</button></a>&nbsp; </div>
			</td>
		</tr>
		<?php }; ?>
