...
<html>
	...
	<body>
		...
		<hr>
		<center><h3>Batu Pahat &nbsp; &nbsp; &nbsp; |  &nbsp; &nbsp; &nbsp; Tambah Kedai</h3></center>
		<hr>
		<br><br>

		<form action="tambahjualpro.php" method="post" name="form1" id="form1" enctype="multipart/form-data">
			<table align="center">
			  <tr>
			  ...
			  <tr>
				<td><div><strong>Lokasi</strong></div></td>
				<td><div><strong>:</strong></div></td>
